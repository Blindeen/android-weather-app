...
public class Constants {
    ...
    public final static String API_URL = "https://api.openweathermap.org";
    public final static String UNITS = "metric";
    public final static String DEFAULT_CITY = "Warsaw 52.2319581 21.0067249 PL Masovian Voivodeship";
